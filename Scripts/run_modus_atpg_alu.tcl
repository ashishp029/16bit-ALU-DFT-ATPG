puts "\n============================================="
puts "Starting Modus Test Run Script for alu_16bit";
puts "=============================================\n"
...
set NETLIST $WORKDIR/alu_16bit_post_dft.v

## Dynamically locate 90nm Verilog library models
## (same FOUNDRY path as run_genus_dft_alu.tcl)
...
puts "\n============================================="
puts "Modus Run Complete  —  alu_16bit"
