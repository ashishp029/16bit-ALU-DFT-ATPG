...
puts "============================================================"
puts "  Genus Synthesis + DFT Script for alu_16bit"
...
#          muxed_scan style — consistent with course reference flow
#---------------------------------------------------------------------
...
write_hdl > ./alu_16bit_pre_dft.v
write_sdc > ./alu_16bit_pre_dft.sdc
...
write_hdl > ./alu_16bit_post_dft.v
write_sdf > ./alu_16bit_post_dft.sdf
write_sdc > ./alu_16bit_post_dft.sdc
write_scandef > ./alu_16bit.scandef

#---------------------------------------------------------------------
# Step 15: Write DFT/ATPG files for Modus
#---------------------------------------------------------------------
puts "\n>>> Writing DFT Protocol for Modus..."
write_dft_atpg -library ./alu_16bit_post_dft.v \
               -directory ./

puts "\n============================================================"
puts "  Genus Synthesis + DFT Complete! (90nm)  —  alu_16bit"
