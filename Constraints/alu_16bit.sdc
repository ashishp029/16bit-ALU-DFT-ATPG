...
# -----------------------------------------------------------------------------
set_input_delay  5.0 -clock clk [get_ports {A B op en rst_n}]
set_output_delay 5.0 -clock clk [get_ports {Y flag_zero flag_carry flag_overflow flag_neg}]
...
# -----------------------------------------------------------------------------
set_driving_cell -lib_cell INVX1 -pin ZN [get_ports {clk rst_n A B op en scan_en scan_in}]
